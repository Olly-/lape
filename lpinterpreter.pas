...
procedure UnsafeRunCode(const Emitter: TLapeCodeEmitter; var DoContinue: TInitBool; const InitialVarStack: TByteArray; const InitialJump: TCodePos;
                        var Stack, VarStack: TByteArray; var VarStackStack: TVarStackStack; var TryStack: TTryStack; var CallStack: TcallStack);
implementation
