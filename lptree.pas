...
begin
  ...
  try
    LengthVar := _ResVar.New(FCompiler.getTempVar(ltSizeInt));
...
begin
  if (FResType = nil) and (FParams.Count > 0) then
    ...
    begin
      ...
      begin
        if AVar.HasType() and AVar.VarType.NeedInitialization then
          FCompiler.Emitter._InitStackLen(AVar.VarType.Size, Offset, @DocPos);
  ...
  begin
    ...
    try
      ...
      if (MemPos = mpVar) then
        ...
        FCompiler.Emitter._InitStackLen(Par.VarType.Size, Offset, @DocPos);
